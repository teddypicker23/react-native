...
RUN wget https://adoptopenjdk.jfrog.io/adoptopenjdk/deb/pool/main/a/adoptopenjdk-8-openj9-jre/adoptopenjdk-8-openj9-jre_8u212-b03.openj9-0.14.0-1_amd64.deb
RUN mkdir -p /usr/share/man/man1/
RUN apt install -y ./adoptopenjdk-8-openj9-jre_8u212-b03.openj9-0.14.0-1_amd64.deb
RUN apt-get update
RUN wget http://mirrors.kernel.org/ubuntu/pool/universe/o/openjdk-8/openjdk-8-jre_8u252-b09-1ubuntu1_amd64.deb
RUN apt install -f -y ./openjdk-8-jre_8u252-b09-1ubuntu1_amd64.deb
